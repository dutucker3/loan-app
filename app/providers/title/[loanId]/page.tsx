...
const REQUIRED = [
  ...
  'Prelim Combined Closing Statement',
  'E & O Insurance',
];

export default function TitleProviderPortal() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/providers/verify?loanId=${loanId}&type=title&token=${encodeURIComponent(t)}`)
      .then(r => r.json())
      .then(j => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold">Title Company Document Upload</h1>
      ...
      <div className="mb-6">
        <h2 className="font-semibold mb-3">Required Documents (4)</h2>
      ...
      <div className="text-xs text-gray-500">
        Once all items are uploaded the lender will be notified automatically. You may upload additional versions if needed. Contact the lender using the reply address on the original email if you have questions.
      </div>
    </div>
  );
}
